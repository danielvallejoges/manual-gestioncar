...
const NAV = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'rol-agendador',  label: 'Recepcionista' },
...
const SEARCH_INDEX = [
  ...
  { module: 'Configuración', title: 'Configuración General', file: 'configuracion.html', hash: 'config-general', text: 'IVA, horas máximas por trabajo, solicitar compra por defecto. Campos requeridos de clientes y vehículos. Inventario: estado para reservar y descontar stock. Descuentos: aprobación vendedor, bloquear edición OT completamente facturada. PDFs: ocultar subcategoría, formato PDF. Calendario: hora inicio/fin, días hábiles, ocultar ventas de mesón, tiempo cliente no llegó. Agendamiento: horarios, límite de citas, URL agendamiento, redirección. Contraseña para eliminar OT por sucursal.' },
  ...
  { module: 'Configuración', title: 'PDF', file: 'configuracion.html', hash: 'config-pdf', text: 'Configuración PDF Checklist de Trabajos para mecánicos. Seleccionar categorías de productos. Campos de precio a mostrar: Precio Venta, Precio Total, Costo Neto (Comisión), Unidades, Precio Unitario. Vista previa en tiempo real.' },
  ...
  { module: 'Roles y Permisos', title: 'Resumen comparativo', file: 'roles-permisos.html', hash: 'resumen', text: 'Tabla comparativa de acceso por módulo para todos los roles: Super Administrador, Administrador, Jefe de Taller, Vendedor, Recepcionista, Mecánico, Encargado de Inventario, Encargado de Compras.' },
  ...
  { module: 'Roles y Permisos', title: 'Recepcionista', file: 'roles-permisos.html', hash: 'rol-agendador', text: 'Calendario, OTs, clientes, vehículos. Sin acceso a presupuestos, finanzas, compras ni administración.' },
